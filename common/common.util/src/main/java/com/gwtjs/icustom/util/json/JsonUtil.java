package com.gwtjs.icustom.util.json;
...
public class JsonUtil {
	 ...
	 * @return
	 */
	public static Object[] getDTOArray(String jsonString, Class<? extends Object> clazz, Map<String,Object> map) {
		setDataFormat2JAVA();
		JSONArray array = JSONArray.fromObject(jsonString);
		Object[] obj = new Object[array.size()];
		for (int i = 0; i < array.size(); i++) {
	 ...
	 * @return
	 */
	public static List<?> getDTOList(String jsonString, Class<?> clazz, Map<String,Object> map) {
		setDataFormat2JAVA();
		JSONArray array = JSONArray.fromObject(jsonString);
