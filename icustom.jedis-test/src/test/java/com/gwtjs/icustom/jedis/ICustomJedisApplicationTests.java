...
import com.gwtjs.icustom.jedis.ICustomJedisApplication;

/**
 * Tests for {@link ICustomJedisApplication}.
 *
 * @author Dave Syer
 */
public class ICustomJedisApplicationTests {
	...
	public void testDefaultSettings() throws Exception {
		try {
			ICustomJedisApplication.main(new String[0]);
		}
		catch (Exception ex) {
