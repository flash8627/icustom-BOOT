...
/**
 * ClassName: BasicErrorController Description:
 *
 */
@Controller
...
public class MyBasicErrorController extends AbstractErrorController {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(MyBasicErrorController.class);
	@Autowired
	...
	public MyBasicErrorController(ErrorAttributes errorAttributes,
		...
		this(errorAttributes, errorProperties, Collections
				.<ErrorViewResolver> emptyList());
	}
