...
public abstract interface ContentHandler {
	...
	public abstract boolean startObjectEntry(String paramString) throws ParseException, IOException;
	...
	public abstract boolean primitive(Object paramObject) throws ParseException, IOException;
}
