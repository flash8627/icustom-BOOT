...
@EnableEurekaClient
@RestController
public class ICustomCloudEurekaClientApplication {
	
	private static final ICustomLogger log = ICustomLoggerFactory
			.getLogger(ICustomCloudEurekaClientApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(ICustomCloudEurekaClientApplication.class, args);
